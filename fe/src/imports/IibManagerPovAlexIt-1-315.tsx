import svgPaths from "./svg-jk2vg12oxn";
...
function Heading() {
  return (
    <div className="content-stretch flex h-[31.992px] items-start relative shrink-0 w-full" data-name="Heading 1">
      <p className="basis-0 font-['Arial:Regular',sans-serif] grow leading-[32px] min-h-px min-w-px not-italic relative shrink-0 text-[#1d293d] text-[24px] text-center tracking-[-0.6px]">MedStaff Portal</p>
    </div>
  );
}
